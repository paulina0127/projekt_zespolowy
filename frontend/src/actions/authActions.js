...
export const change_password = (new_password, re_new_password, current_password) => async (dispatch) => {
  const config = { headers: getAuthHeaders() }
  try {
    dispatch({
...
export const change_email = (new_email, re_new_email, current_password) => async (dispatch) => {
  const config = { headers: getAuthHeaders() }
  try {
    dispatch({
