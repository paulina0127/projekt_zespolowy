...
const CandidateEducation = () => {
  ...
  const educationList = useSelector(state => state.userProfileDetails.educationList)
    ...
    <UserPanelLayout>
      <div className='container mt-3'>
        ...
        <CandidateTable
          ...
          th_list={th_list}
        > 
          {!loading && educationList && educationList.results.map((education, index) => 
          <tr key={education.id}>
            ...
            <MyModal showModal={true} title='Usuwanie wykształcenia' danger={true}>
              <CandidateInfoDelete
