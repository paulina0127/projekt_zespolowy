...
const NewApplication = ({ offer, isAuthenticated, showModal, handleCloseModal }) => {
    ...
    <Modal show={showModal} size="md" aria-labelledby="contained-modal-title-vcenter" centered>
      <Modal.Header className='bg-warning'>
        <Modal.Title>
          ...
          <h4><strong>{offer.position}</strong></h4>
      ...
      <Modal.Body>
        ...
        user && user.location && filesList !== undefined ? (
          <Row>
            ...
            <Row className='my-3'>
              <ApplicationForm initialValues={initialValues} filesList={filesList} handleCloseModal={handleCloseModal} applyMethod={applyMethod}/>
            </Row>
          </Row> 
        ) : ''}
      </Modal.Body>
