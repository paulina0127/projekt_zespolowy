...
import { TextField, SelectField, CategorySelect, CheckboxGroup, MyDatePicker } from '../formHelpers'
    ...
    <>
      ...
      {({ values }) => (
        <Form>
          <div className='row mt-4'>
            ...
            <div className='col-md-3'>
              <SelectField
                ...
                name='position_level'
                options={[
                  { label: 'Praktykant / Stażysta', value: 'Praktykant / Stażysta' },
                  { label: 'Asystent', value: 'Asystent' },
                  { label: 'Młodszy specjalista (Junior)', value: 'Młodszy specjalista (Junior)' },
                  { label: 'Specjalista (Mid / Regular)', value: 'Specjalista (Mid / Regular)' },
                  { label: 'Starszy specjalista (Senior)', value: 'Starszy specjalista (Senior)' },
                  { label: 'Ekspert / Lider', value: 'Ekspert / Lider' },
                  { label: 'Kierownik', value: 'Kierownik' },
                  { label: 'Menedżer', value: 'Menedżer' },
                  { label: 'Dyrektor / Prezes', value: 'Dyrektor / Prezes' },
                  { label: 'Pracownik fizyczny', value: 'Pracownik fizyczny' },
                ]}
          ...
          <div className='row mt-4'>
            <div className='col-md-3'>
              <CheckboxGroup label='Wymiar etatu' name='working_time' options={[
                  { value: 'Pełny etat', label: 'Pełny etat' },
                  { value: 'Część etatu', label: 'Część etatu' },
                  { value: 'Praca dodatkowa / tymczasowa', label: 'Praca dodatkowa / tymczasowa' },
                ]} />
            </div>
            <div className='col-md-3'>
              <CheckboxGroup label='Tryb pracy' name='working_mode' options={[
                { value: 'Praca zdalna', label: 'Praca zdalna' },
                { value: 'Praca hybrydowa', label: 'Praca hybrydowa' },
                { value: 'Praca stacjonarna', label: 'Praca stacjonarna' },
                { value: 'Praca mobilna', label: 'Praca mobilna' },
              ]} />
            </div>
            <div className='col-md-3'>
              <CheckboxGroup label='Rodzaj umowy' name='contract_type' options={[
                ...
                { value: 'Umowa o pracę tymczasową', label: 'Umowa o pracę tymczasową' },
                { value: 'Umowa na zastępstwo', label: 'Umowa na zastępstwo' },
          ...
          <div className='row mt-4'>
            ...
            <div className='col-md-3'>
              <CategorySelect categoryLabel='Kategoria' name='category' categories={categories} />
            </div>
          </div>
          <div className='row mt-4'>
