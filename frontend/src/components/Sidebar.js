  ...
  const candidateLinks = () => (
    <>
      <Link
        ...
        className={pathname === '/user-panel/profil' ? 'active' : ''}
      >
      ...
      <Link
        ...
        className={pathname === '/user-panel/moje-aplikacje' ? 'active' : ''}
      >
        <li className='nav-item text-white fs-5 my-2'>
          <FaRegAddressCard className='ms-3' />
      ...
      <Link
        ...
        className={pathname === '/user-panel/dokumenty' ? 'active' : ''}
      >
        <li className='nav-item text-white fs-5 my-2'>
  ...
  const companyLinks = () => (
    <>
      ...
      <Link
        ...
        className={pathname === '/user-panel/moje-oferty' ? 'active' : ''}
      >
        <li className='nav-item text-white fs-5 my-2'>
      ...
      <Link
        ...
        className={pathname === '/user-panel/aplikacje' ? 'active' : ''}
      >
        <li className='nav-item text-white fs-5 my-2'>
    ...
    <div className='bg-dark col-auto col-md-3 col-lg-2 min-vh-100'>
      ...
      <ul className='nav nav-pills flex-column'>
        ...
        <Link
          ...
          className={pathname === '/user-panel/konwersacje' ? 'active' : ''}
        >
          <li className='nav-item text-white fs-5 my-2'>
