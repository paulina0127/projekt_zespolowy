        ...
        {searchFormLoading ? (
          ...
          <>
              ...
              <Message>
                ...
                <Link to='/rejestracja' className='text-primary fw-bold'> Załóż konto</Link> lub
                <Link to='/logowanie' className='text-primary fw-bold'> Zaloguj się</Link>
                , aby móc aplikować
              </Message>
            ) : user.profile === null ? (
              <Message>
                Zauważyliśmy, że nie posiadasz profilu kandydata. 
                <Link to='/user-panel/dane-osobowe' className='text-primary fw-bold'> Załóż go</Link>
                , aby móc aplikować
              </Message>
            ) : (
              ''
